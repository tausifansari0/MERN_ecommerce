...
const ProductList =({products,addToCart})=> (
    ...
    {products.map(product=><div className="col-xl-3 col-lg-4 col-md-6 position-relative">
          ...
          <div className="card product-item">
            ...
            <Link to={`/product/${product._id}`}> <img src={`images/${product.image}.jpg`} className="card-img-top" alt="..." data-bs-toggle="tooltip" data-bs-placement="top" title="Click to See Product Details"/></Link>
